...
SECRET_KEY = 'django-insecure-)rujxgy2ur)rr735#+9l4*)doa!mie_*w0t75fx&udfyhhc6a8'
...
SESSION_COOKIE_SECRET = 'your-secret-key-here'

# Configure the session cookie name (optional)
